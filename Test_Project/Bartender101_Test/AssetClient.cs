...
namespace AssetClient
{
    ...
    public class AssetClient : RestClient
    {
        ...
        /// <returns></returns>
        public T Get<T>(string url, Dictionary<string,object> query_list = null) where T : class, new()
        {
            ...
            var Task = ExecuteRequestAsync<T>(request);
            return Task.Result;
        }
        ...
        /// <returns></returns>
        public T Put<T>(string url, object data) where T : class, new()
        {
